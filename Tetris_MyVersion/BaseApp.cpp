...

{
	...
	// Check if possible to allocate memory for proccesses
	...
	// Allocate memory for the buffer of game 
...
// Called when we need to change/get symbol on the screen
